// Project: XnaShooter, File: ShadowMap.fx
// Path: XnaShooter, Author: abi
// Creation date: 04.10.2006 13:01
// Last modified: 06.10.2006 17:21
...
technique UseShadowMap
{
	pass P0
	{
		...
		// Using PS Instructions directly here, easier to tweak. For more info see:
		// http://msdn.microsoft.com/library/default.asp?url=/library/en-us/directx9_c/directx/graphics/reference/AssemblyLanguageShaders/PixelShaders/ps_1_X.asp
		...
		pixelshader = asm
		{
			...
			// Use -0.5 bias for cnd formular (comparing to +0.5)
...
//unused: float2 shadowMapTextureSize = float2(1024.0f, 1024.0f);
